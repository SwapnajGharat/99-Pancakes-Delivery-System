    ...
    <div className="max-w-md mx-auto px-4 py-12 sm:py-20">
      <div className="bg-white rounded-3xl p-8 border border-amber-100 shadow-xl space-y-6">
        ...
        <div className="p-3 bg-amber-50/70 border border-amber-200/60 rounded-2xl text-[11px] text-amber-900 space-y-1">
          ...
          <p>👑 Admin: <span className="font-mono bg-white px-1.5 py-0.5 rounded border border-amber-200">swapnaj@gmail.com</span> / <span className="font-mono bg-white px-1.5 py-0.5 rounded border border-amber-200">1234567890</span></p>
