              ...
              <div className="flex items-center justify-between w-full sm:w-auto gap-6 pt-2 sm:pt-0 border-t sm:border-t-0 border-amber-50">
                ...
                <div className="flex items-center gap-2 border border-amber-200 rounded-full px-2 py-1 bg-[#FFF8F0]">
                  <button
                    ...
                    className="w-7 h-7 rounded-full bg-white text-[#5C3D2E] hover:bg-amber-100 flex items-center justify-center font-bold text-xs"
                  >
                    <FiMinus />
                  </button>
                  ...
                  <button
                    onClick={() => updateQuantity(product.id, 1)}
                    className="w-7 h-7 rounded-full bg-[#5C3D2E] text-white hover:bg-[#4A3024] flex items-center justify-center font-bold text-xs"
                  >
                    <FiPlus />
                  </button>
                </div>
